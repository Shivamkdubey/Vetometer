...
import 'package:vetometer/poll_stats.dart';
import 'package:vetometer/vetometer_screen.dart';
import 'package:vetometer/view_poll.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      initialRoute: VetometerScreen.id,
      routes: {
